...
import net.minecraft.world.level.block.state.BlockState;import java.util.*;


public class fastools {
    ...
    private static void breakTree(Level level, Player player, BlockPos startPos,
                                  BlockState startState, ItemStack tool) {
    ...
    private static void breakVein(Level level, Player player, BlockPos startPos,
                                  BlockState startState, ItemStack tool) {
        if (level.isClientSide) return;
    ...
    private static void breakBlock(Level level, Player player, BlockPos pos, ItemStack tool) {
